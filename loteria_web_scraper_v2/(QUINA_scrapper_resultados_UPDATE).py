...
patch_arquivo = 'arquivos_CSV\QUINA_resultados_CSV.csv'
...
for c in range(c_inicial, (int(n_concurso_atual)+1)):
    ...
    for i in range(1,6): # LOOP PARA FACILITAR A CAPTURA DAS DEZENAS 01 A 05, SEM PRECISAR UTILIZAR 5 LINHAS
