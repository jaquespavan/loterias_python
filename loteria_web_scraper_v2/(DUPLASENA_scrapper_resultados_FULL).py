...
url = 'https://loterias.caixa.gov.br/Paginas/Dupla-Sena.aspx'
...
for c in range(c_inicial, (int(n_concurso_atual)+1)): #+1
    ...
    for i2 in range(1,3): # LOOP PARA FACILITAR A CAPTURA DOS SORTEIOS 1 E 2, SEM PRECISAR UTILIZAR 2 FORS
        for i in range(1, 7): # LOOP PARA FACILITAR A CAPTURA DAS DEZENAS 01 A 06, SEM PRECISAR UTILIZAR 6 LINHAS
            # XPath = //*[@id="wp_resultados"]/div[2]/div/div/ul[1]/li[1]

            xpath_n = '//*[@id="wp_resultados"]/div[2]/div/div/ul['+str(i2)+']/li['+str(i)+']'
            #print(xpath_n)
...
nome_arquivo = 'arquivos_CSV\DUPLASENA_resultados_CSV.csv'

with open(nome_arquivo, 'w') as arquivo:
    arquivo.write('Concurso;Data_concurso;Dezena_1_01;Dezena_1_02;Dezena_1_03;Dezena_1_04;Dezena_1_05;Dezena_1_06;Dezena_2_01;Dezena_2_02;Dezena_2_03;Dezena_2_04;Dezena_2_05;Dezena_2_06;')
    arquivo.write('\n')
